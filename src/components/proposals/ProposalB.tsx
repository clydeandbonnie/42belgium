...
export function ProposalB() {
  return (
    <>
        ...
        <div className="relative mx-auto max-w-5xl px-6 pb-24 pt-28 sm:pb-32 sm:pt-36">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-5xl font-bold leading-[1.1] tracking-tight sm:text-6xl lg:text-7xl">
              ...
              <br />
              <span className="text-[var(--color-primary)]">No experience needed.</span>
            </h1>
            <p className="mt-8 text-xl leading-relaxed text-zinc-500 max-w-2xl mx-auto">
          ...
          <div className="grid gap-12 sm:grid-cols-3">
            {[
              ...
              <div key={i} className="text-center">
                ...
                <i className={`${item.icon} text-zinc-300 text-2xl mb-4 block`} />
      ...
      {/* ─── FINAL CTA ─── */}
      <section className="bg-gradient-to-r from-[var(--color-primary)] to-[#009e9f] text-white" id="apply">
        <div className="mx-auto max-w-5xl px-6 py-20 sm:py-28">
          <div className="max-w-2xl mx-auto text-center">
            <i className="fa-solid fa-heart text-3xl mb-6 text-white/60 block" />
